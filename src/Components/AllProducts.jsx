                        ...
                        <div className="row">
                            ...
                            <div className="mn-shop-rightside col-md-12 m-t-991">
                                ...
                                <div className="mn-select-bar d-flex">
                                    ...
                                    <span className="mn-select-btn">Stickers<a className="mn-select-cancel"
                                        href="javascript:void(0)">×</a></span>
                                    <span className="mn-select-btn">Tables Book<a className="mn-select-cancel"
                                        href="javascript:void(0)">×</a></span>
                                    <span className="mn-select-btn">Pencils<a className="mn-select-cancel"
                                        href="javascript:void(0)">×</a></span>
                                    <span className="mn-select-btn mn-select-btn-clear"><a className="mn-select-clear"
                                            ...
                                            {/* <div
                                                ...
                                                <div className="mn-product-card">
                                                    <div className="mn-product-img">
                                                        ...
                                                        <div className="mn-img">
                                                            <a href="product-detail.html" className="image">
                                                                <img className="main-img" src="assets/img/product/17.jpg"
                                                                    alt="product" />
                                                                <img className="hover-img" src="assets/img/product/18.jpg"
                                                                    alt="product" />
                                                            </a>
                                                    ...
                                                    <div className="mn-product-detail">
                                                        ...
                                                        <p className="mn-info">Lorem Ipsum is simply dummy text of the
                                                        ...
                                                        return (
                                                            <div
                                                                ...
                                                                className={`${viewMode === "grid"
                                                                    ...
                                                                    : "col-md-6"
                                                                    } m-b-24 mn-product-box pro-gl-content`}
                                                            >
