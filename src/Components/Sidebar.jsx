...
import { SidebarType, calculateCartItemTotals, menuItems, serverPort } from "./Constants";
        ...
        >
                            ...
                            >
                                ...
                                <div className="d-flex flex-column">
                                    ...
                                    <span className="text-sm">
                                        Rs {item?.cartAddedOption[0]?.optionPrice}.00 × {item.cartQuantity}
                                    </span>
            ...
            {sidebarType === SidebarType.MENU && (
                <div className="menu-sidebar d-flex flex-column justify-content-between">
                    ...
                    <ul className="list-unstyled menu-list flex-grow-1">
                        {menuItems.map((menu, index) => (
                            <li key={index} className="menu-item p-2 mt-2">
                                <div
                                    className="d-flex justify-content-between align-items-center"
                                    onClick={() =>
                                        menu.children ? toggleMenu(menu.name) : nav(menu.path)
                                    }
                                >
