                ...
                <div className="mn-cat-card cat-card-3">
                  ...
                  <ul>
                    ...
                    <li>
                      <a href="shop-right-sidebar.html">
                        <img
                          src="/src/assets/img/category/9.jpg"
                          alt="category"
                        />
                      </a>
                    </li>
                ...
                <div className="mn-cat-card cat-card-4">
                  ...
                  <ul>
                    <li>
                      <a href="shop-right-sidebar.html">
                        <img
                          src="/src/assets/img/category/10.jpg"
                          alt="category"
                        />
                      </a>
                    </li>
                    <li>
                      <a href="shop-right-sidebar.html">
                        <img
                          src="/src/assets/img/category/11.jpg"
                          alt="category"
                        />
                      </a>
                    </li>
                    <li>
                      <a href="shop-right-sidebar.html">
                        <img
                          src="/src/assets/img/category/12.jpg"
                          alt="category"
                        />
                      </a>
                    </li>
                ...
                <div className="mn-cat-card cat-card-5">
                  ...
                  <ul>
                    <li>
                      <a href="shop-right-sidebar.html">
                        <img
                          src="/src/assets/img/category/13.jpg"
                          alt="category"
                        />
                      </a>
                    </li>
                    <li>
                      <a href="shop-right-sidebar.html">
                        <img
                          src="/src/assets/img/category/14.jpg"
                          alt="category"
                        />
                      </a>
                    </li>
                    <li>
                      <a href="shop-right-sidebar.html">
                        <img
                          src="/src/assets/img/category/15.jpg"
                          alt="category"
                        />
                      </a>
                    </li>
                ...
                <div className="mn-cat-card cat-card-6">
                  ...
                  <ul>
                    <li>
                      <a href="shop-right-sidebar.html">
                        <img
                          src="/src/assets/img/category/16.jpg"
                          alt="category"
                        />
                      </a>
                    </li>
                    <li>
                      <a href="shop-right-sidebar.html">
                        <img
                          src="/src/assets/img/category/17.jpg"
                          alt="category"
                        />
                      </a>
                    </li>
                    <li>
                      <a href="shop-right-sidebar.html">
                        <img
                          src="/src/assets/img/category/18.jpg"
                          alt="category"
                        />
                      </a>
                    </li>
                ...
                <div className="col-md-12">
                  <div className="testim-bg">
                    ...
                    <div className="mn-test-outer mn-testimonials">
                      <ul className="mn-testimonial-slider">
                  ...
                  <div className="insta-auto">
                    ...
                    <div className="mn-insta-item">
                      <div className="mn-insta-inner">
                        <a href="#" target="_blank">
                          <img
                            src="/src/assets/img/instagram/4.jpg"
                            alt="insta"
                          />
                        </a>
                      </div>
                    ...
                    <div className="mn-insta-item">
                      <div className="mn-insta-inner">
                        <a href="#" target="_blank">
                          <img
                            src="/src/assets/img/instagram/5.jpg"
                            alt="insta"
                          />
                        </a>
                      </div>
                    ...
                    <div className="mn-insta-item">
                      <div className="mn-insta-inner">
                        <a href="#" target="_blank">
                          <img
                            src="/src/assets/img/instagram/6.jpg"
                            alt="insta"
                          />
                        </a>
                      </div>
                    ...
                    <div className="mn-insta-item">
                      <div className="mn-insta-inner">
                        <a href="#" target="_blank">
                          <img
                            src="/src/assets/img/instagram/7.jpg"
                            alt="insta"
                          />
                        </a>
                      </div>
